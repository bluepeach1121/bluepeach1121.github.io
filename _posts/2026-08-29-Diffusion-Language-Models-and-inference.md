...
Putting in our initial $f(x_t, t)$ expression, the corresponding probability flow ODE is 

$$ 
\frac{dx}{dt} = -\frac{1}{2}\beta(t)x_t - \frac{1}{2}\beta(t)s_\theta(x_t,t) 
$$

From here we can define a velocity field 

$$ 
v_t(x) = -\frac{1}{2}\beta(t) \left[ x+s_\theta(x,t) \right] 
$$
